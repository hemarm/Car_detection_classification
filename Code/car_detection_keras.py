...
#Create a Matrix to flatten all values
X_train = []
Y_train = []
X_test = []
Y_test = []
...
# It's a binary-class problem, output is 0 (CAR) and 1(NOT CAR). 
#it's a good practice to use "one hot encoding" to class values 
